...
public class WebScraper {
    ...
    public ArrayList<Reading> getReadingsFromWeb(String url, ArrayList<Reading> listOfReadings) throws IOException {
    ...
    public ArrayList<Reading> getReadingsFromFile(String fileLocation, ArrayList<Reading> listOfReadings) throws IOException {
